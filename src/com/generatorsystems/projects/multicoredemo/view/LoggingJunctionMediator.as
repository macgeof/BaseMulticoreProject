		...
		override public function handleNotification( __note:INotification ):void
		{
			...
			switch( __note.getName() )
			{
                ...
                case LogMessage.SEND_TO_LOG:
                    ...
                    junction.sendMessage( GBPipeAwareFlexCore.STDLOG, __logMessage );
                    break;
                ...
                case LogFilterMessage.SET_LOG_LEVEL:
                    ...
                    var __changedLevel:Boolean = junction.sendMessage( GBPipeAwareFlexCore.STDLOG, __setLogLevelMessage );
                    ...
                    var __logChanged:Boolean = junction.sendMessage( GBPipeAwareFlexCore.STDLOG, __changedLevelMessage );
                    break;
